...
proc drawBig7Seg {pos} {
  ...
  moverel 8.7 13.6;
  pen orange; fillcircle $DP1Rad; pen black; circle $DP1Rad;
...
proc drawSmall7Seg {pos} {
  ...
  circle $DP2Rad;
  moverel -25.4 0;
  pen orange; fillcircle $DP2Rad; pen black; circle $DP2Rad;
...
moveto [expr [X $board1UL] + $wd2DP1L - 2 * 2.54] [expr [Y $board1UL] + $DP1LoffsY];
for { set i 0} {< $i 5} { incr $i} {
  pen lightgray; fillcircle $DP1LholeRad;
  pen black; circle $DP1LholeRad; fillcircle 0.5;
  moverel 2.54 0;
}
...
moveto [expr [X $board2UL] + $wd2DP2L - 1.5 * 2.54] [expr [Y $board2UL] + $DP2LoffsY];
for { set i 0} {< $i 4} { incr $i} {
  pen lightgray; fillcircle $DP2LholeRad;
  pen black; circle $DP2LholeRad; fillcircle 0.5;
  moverel 2.54 0;
}
